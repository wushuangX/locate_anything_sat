...
| | 100k 基线 | d250 | d500 | d750 | d1000 |
|---|---:|---:|---:|---:|---:|
| F1 | **0.404** | 0.373 | 0.362 | 0.347 | 0.352 |
| AP50 | **0.241** | 0.197 | 0.191 | 0.200 | 0.200 |
| small AP50 | **0.098** | 0.092 | 0.081 | 0.076 | 0.082 |
| SV AP50 | **0.154** | 0.146 | 0.139 | 0.132 | 0.139 |
| AP | 0.101 | 0.094 | 0.098 | 0.093 | **0.103** |

四个 dense ckpt 在 F1/AP50/small AP50/SV AP50 全部低于基线；3-seed 子集里 d1000 的回升是「比更差的兄弟好」，全量上不存在。**终判：现有奖励/协议下 dense GRPO 为净伤害。**（score=1.0 AP 协议下全量绝对值系统性低于 50 张子集，协议效应，只做同协议内比较。）
